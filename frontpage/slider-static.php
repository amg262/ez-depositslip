...
<div id="stat_img"
     class="<?php if ( ! empty( $optimizer['static_image_id']['url'] ) ) { ?> stat_has_img<?php } ?><?php if ( ! empty( $optimizer['static_gallery'] ) ) { ?> stat_has_slideshow<?php } ?>">
	...
	<?php if ( ! empty( $statimg['url'] ) ) { ?>
        <img id="statimg_99" class="stat_bg_img" src="<?php echo esc_url( $statimg['url'] ); ?>"
